...
import application.minseong.capstone.R;
...
import application.minseong.capstone.java.automl.AutoMLImageLabelerProcessor;
import application.minseong.capstone.java.barcodescanning.BarcodeScanningProcessor;
import application.minseong.capstone.java.custommodel.CustomImageClassifierProcessor;
import application.minseong.capstone.java.facedetection.FaceContourDetectorProcessor;
import application.minseong.capstone.java.facedetection.FaceDetectionProcessor;
import application.minseong.capstone.java.imagelabeling.ImageLabelingProcessor;
import application.minseong.capstone.java.objectdetection.ObjectDetectorProcessor;
import application.minseong.capstone.java.textrecognition.TextRecognitionProcessor;
