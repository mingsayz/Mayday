...
import application.minseong.capstone.common.GraphicOverlay.Graphic;
...
public class BarcodeGraphic extends Graphic {
  ...
  public static String gps_position = null;
  ...
  public void draw(Canvas canvas) {
    ...
    gps_position = barcode.getRawValue();
...
//            MapsInitializer.initialize(QRcodeTest.this);
//
